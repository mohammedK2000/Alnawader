...
final bool wh;
  ...
  factory SearchableDropdown.single({
    ...
    dynamic icon = const   ImageIcon(
        AssetImage('assets/arrowDown.png'),
        size: 24, color: Color.fromRGBO(248, 199, 0, 1),
...
class _SearchableDropdownState<T> extends State<SearchableDropdown<T>> {
  ...
  Widget build(BuildContext context) {
      ...
      items.add(DefaultTextStyle(
        style:TextStyle(    fontFamily: 'Cairo',
                               fontSize: size1,fontWeight: FontWeight.w600,
                                color:widget.wh?Colors.black: Colors.white),
        child: IgnorePointer(
          child: emplacedHint,
    ...
    var labelOutput = prepareWidget(widget.label, parameter: selectedResult,
      ...
      return (Text(string,
          style: TextStyle(color:Color.fromRGBO(74, 74, 74, 1), fontSize: 13)));
    });
    return Column(
      crossAxisAlignment: CrossAxisAlignment.center,
        ...
        child: new Stack(
          children: <Widget>[
            new TextField(
              ...
              cursorColor: Color.fromRGBO(251, 176, 59, 1),
